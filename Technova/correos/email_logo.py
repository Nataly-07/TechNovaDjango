...
3. Si en el .env la dejaste explícitamente vacía: ``{TECHNOVA_PUBLIC_BASE_URL}/static/.../logo-technova.png``
"""
...
STATIC_LOGO_PATH = "/static/frontend/imagenes/logo-technova.png"
